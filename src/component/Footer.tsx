    ...
    <div className="border-t border-[#f1f5f9]">
      ...
      {/* bottom */}
        <div className="flex justify-between items-center py-5">
          <p className="text-[#64748B] font-normal text-[14px] font-sans">© 2026 Dev Stack. All rights reserved.</p>
           <ul className="flex gap-5 text-[#475569] text-[14px] font-normal font-sans">
