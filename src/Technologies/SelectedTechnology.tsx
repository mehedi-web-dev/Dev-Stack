...
toast.error("Remove All Stack");};
  ...
  return (
    <div className="md:container md:mx-auto md:py-12 md:my-0 my-10  rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
 ...
 <div className="flex items-center gap-3">
  ...
  <button
    onClick={() => handleRemove(tech.id)} className=" cursor-pointer text-2xl font-light text-gray-400 transition
     hover:text-red-500" >  {<LuX></LuX>} </button></div>))}</div>)}
